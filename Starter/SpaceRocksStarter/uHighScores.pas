...
uses
  ...
  FMX.Layouts, FMX.ListBox, FMX.Objects, FMX.ListView.Types, FMX.ListView,
  FMX.Controls.Presentation, FMX.Edit, FMX.ListView.Appearances, FMX.ListView.Adapters.Base;
