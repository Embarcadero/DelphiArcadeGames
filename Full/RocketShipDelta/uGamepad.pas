...
type
  TFrameGamepad = class(TFrame)
    ...
    procedure BombBTNMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
    procedure WarpBTNMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
...
const
  ...
  FIREACTIONDOWN_C = 51;
  FIREACTIONUP_C = 52;
  WARPACTIONCLICK_C = 60;
  BOMBACTIONCLICK_C = 70;
...
procedure TFrameGamepad.DownBTNMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  ButtonAction(DOWNACTIONDOWN_C);
end;

procedure TFrameGamepad.DownBTNMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TFrameGamepad.WarpBTNMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  ButtonAction(WARPACTIONCLICK_C);
end;

procedure TFrameGamepad.BombBTNMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
